            ...
            <div className="ml-10 flex items-baseline space-x-8">
              {navItems.map((item, index) => (
                <motion.a
                  ...
                  className="text-gray-300 hover:text-white px-4 py-3 text-lg font-medium transition-colors duration-200 relative group"
                >
                  {item.name}
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              {navItems.map((item, index) => (
                <motion.a
                  ...
                  className="text-gray-300 hover:text-white block px-4 py-4 text-lg font-medium transition-colors duration-200"
                >
                  {item.name}
                </motion.a>
              ))}
